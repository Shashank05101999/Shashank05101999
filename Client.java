   ...
   static DataOutputStream dout;
      ...
      Client() //constructor
    {
       f.setLayout(null);
        ...
        //profile image
        ImageIcon i4= new ImageIcon(ClassLoader.getSystemResource("icon/female2.png")); 
        ...
        JLabel name= new JLabel("aishwaiya ");
       ...
       f.setSize(450,700); // comes under the jframe
        f.setLocation(950, 50);  // its use for change the  chatdesktop place
    ...
    public static void main(String[] args) {
       new Client(); //Anonymous  without name
        
       
       try{
           Socket s = new  Socket("21.22.32.8" , 1002);  //8001 is helping for connecting to the client like where we are sending the msg like showing destination
